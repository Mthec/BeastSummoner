...
public abstract class BeastSummonerQuestionExtension extends Question {
    BeastSummonerQuestionExtension(Creature aResponder, String aTitle, String aQuestion, int aType, long aTarget) {
